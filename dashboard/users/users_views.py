...
def users(request):
	...
	if request.method=='POST':
		...
		print('user_email: ',filter_email)
		print('user_mobile: ',filter_mobile)
		print('user_group: ',filter_group)
	...
	if user_list:
		paginator = Paginator(user_list, utils.nodes_per_page()) # Show 7 Users per page.
